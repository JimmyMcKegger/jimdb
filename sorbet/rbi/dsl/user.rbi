...
class User
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def favourite_movie_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def favourite_movie_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :favourite_movies, through: :favourites`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Movie::PrivateCollectionProxy) }
    def favourite_movies; end

    sig { params(value: T::Enumerable[::Movie]).void }
    def favourite_movies=(value); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :favourites`.
